...
| Variant | Description |
| --- | --- | 
| `for(i <- 1 to n)` | For loop from 1 to <img src="build/books/scala_impatient/assets//55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.867000000000003pt height=14.155350000000013pt/> inclusive |
| `for(i <- 0 until n)` | For loop from 0 to <img src="build/books/scala_impatient/assets//55a049b8f161ae7cfeb0197d75aff967.svg?invert_in_darkmode" align=middle width=9.867000000000003pt height=14.155350000000013pt/> exclusive |
